...
oiaApplication.factory('MasterFocusTypeService',
	function MasterFocusTypeService($rootScope, $state, $q, $http) {

		return {
			doSearch: function(param, callback){
				var cb = callback || angular.noop;
        		var deferred = $q.defer();
				if(angular.isUndefined(param.focusType) || param.focusType == ""){
					param.focusType = "ALL";
				}
				var url = ENDPOINT + "master/focusType/"+param.focusType;
				$http.get(url).then(
					function(success){
