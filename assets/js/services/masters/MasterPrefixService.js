...
oiaApplication.factory('MasterPrefixService',
	function MasterPrefixService($rootScope, $state, $q, $http) {

		return {
			doSearch: function(param, callback){
				var cb = callback || angular.noop;
        		var deferred = $q.defer();
				if(angular.isUndefined(param.prefixName) || param.prefixName == ""){
					param.prefixName = "ALL";
				}
				var url = ENDPOINT + "master/prefix/search/"+param.prefixName;
				$http.get(url).then(
					function(success){
