...
function($scope, NgTableParams, $timeout, $parse, $compile, $attrs, $element, ngTableColumn, ngTableEventsChannel) {
    ...
    this.compileDirectiveTemplates = function () {
        if (!$element.hasClass('ng-table')) {
            $scope.templates = {
                header: ($attrs.templateHeader ? $attrs.templateHeader : 'assets/vendors/ng-table/dist/headers.html')
                ,pagination: ($attrs.templatePagination ? $attrs.templatePagination : 'assets/vendors/ng-table/dist/pager.html')
            };
